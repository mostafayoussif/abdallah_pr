...
trainers_name = Home_Frame(root, width = 1820, height = 960)
trainers_name.pack(padx = 50, pady = 150)
...
j = 5
for i in range (0, 20):
    label = Small_Label(trainers_name, fg_color = '#4F0000', text = 'سيف الدين أحمد محمد عبد الرحيم', text_color = 'white', font = ('Cairo Black', 15))
    label.grid(row = j, column = 0, padx = 1500, pady = 10)
    j += 1
